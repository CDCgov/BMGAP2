...
##updated by Carolyn Wiest, February 19, 2025, script_version 2.0
### Uses python 3.7, requires Pandas and Bio.Alphabet replacement

SCRIPT_VERSION = 2.0 #adding RHEL8 formatting
SCRIPT_SUBVERSION =  1
import re
import pandas as pd
has_plt = False
