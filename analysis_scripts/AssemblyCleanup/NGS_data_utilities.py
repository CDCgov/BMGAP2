...
SCRIPT_SUBVERSION =  18#external stuff
...
def main():
    parser = argparse.ArgumentParser(description='A program collect information about NGS data files')
    ...
    #Process misname file if provided
